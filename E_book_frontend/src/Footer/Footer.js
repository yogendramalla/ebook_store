    ...
    return (
      <footer className="page-footer font-small blue-grey lighten-5">
          ...
          <div className="row mt-3 dark-grey-text">
            <div className="col-md-3 col-lg-4 col-xl-5 mb-4">
              <video
                ...
                height="250px"
              >
                <source src="/footer.mp4" type="video/mp4"></source>
              </video>
            </div>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              ></hr>
              <p>
                <i className="fas fa-home mr-3"></i> KTM 10012, Pepsicola
              </p>
              <p>
                <i className="fas fa-envelope mr-3"></i>ebook2020@gmail.com
              </p>
              <p>
        ...
        <div className="footer-copyright text-center text-black-50 py-3">
          © 2020 Copyright:
          <a className="dark-grey-text" href="https://mobilenepals.com/">
            {" "}
            Onlinebookstore.com
          </a>
        </div>
