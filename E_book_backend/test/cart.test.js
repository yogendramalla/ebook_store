...
describe('Test of Cart Route', () => {
    test('it should add a new cart',()=>{
        return cartRouter.create({
            ...
            product:ObjectId('6104077450ae4e163c43610b'),
            totalprice: 850, 
            user: ObjectId('60efd992f1676737d892045e'), 
            quanity: 5,
            notes:'Make little spicy'
        }).then((Response)=>{
            expect(Response.product).toStrictEqual(ObjectId('6104077450ae4e163c43610b'))
            ...
            expect(Response.notes).toBe('Make little spicy') 
        })
    })
    ...
    test('it should update the cart',()=>{
        ...
        .then((Response)=>{
            ...
            expect(Response.notes).toBe('Make more spicy') 
        })
    })
